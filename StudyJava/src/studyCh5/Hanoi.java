...
public class Hanoi {
	...
	/*
	 * 연습문제 5-6 -> 숫자이름이 아닌 문자이름 기둥으로 변경
	 * 
	 */

	static void move2(int no, int x, int y) {
		if (no > 1)
			move2(no - 1, x, 6 - x - y); // 중간으로 옮김
	...
	/*
	 * 연습문제 5-7 -> 실습 5-6 메서드 비재귀적으로 수정.
	 * 
	 */

	static void move3(int no, int x, int y) {
	...
	public static void main(String[] args) {
		...
		move3(no, 1, 3); // 1번 기둥의 n개의 원반을 3번 기둥으로 옮김
	}
